            ...
            <AuthContent>
                {JSON.stringify(transaction) !== "{}"? 
                    <Fragment>
                        ...
                        <p>Thank you for choosing The Nagrand Hotel & Spa as your home away from home.
                            It is our pleasure to confirm your reservation. Please don't hesitate to contact us with any changes on your reservation
                        </p>
                                                ...
                                                <Fragment>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            {
                                                            roomDetails.length ?
                                                                roomDetails.map(rm =>room._id === rm._id ? rm.name : null)
                                                                : null
                                                            }
                                                        </td>
                                                    </tr>
