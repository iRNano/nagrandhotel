                        ...
                        <div className="card w-100">
                            {
                                ...
                                <img src={`${URL}${room.images[0].path}`} className="img-fluid card-img-top"></img>
                                : null
                            }
                ...
                <div className="row px-0 w-100 m-0">
                    <div className="col-12 px-0">
                        <div className="px-5">
                            ...
                            <Heading.H4 location="rooms">A sanctuary set against Mactan's historic downtown</Heading.H4>
                        </div>
                    ...
                    {user && user.isAdmin? 
                        <div className="text-right pr-3">
                            <Link to="/add-room"><Button size="large" location="admin">Add a room</Button></Link>
                        </div> : null
                    }
