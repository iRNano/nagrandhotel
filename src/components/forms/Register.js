...
const Register = () => {
    ...
    return(
        <form className="col-sm-12 mx-auto pt-3" onSubmit={onSubmitHandler}>
            <Heading.H1 location="profile" className="justify-content-center mx-auto">Register</Heading.H1>
            ...
            <div className="form-group">
                ...
                <input className="form-control" type="email" id="email" name="email" onChange={onChangeHandler}/>
            </div>
            <div className="form-group">
            ...
            <Button className="w-100" location="profile">Register</Button> 
        </form>
    )
}
