                        ...
                        <Fragment>
                            ...
                            <div className="row p-5"> 
                                ...
                                <Fragment>
                                    ...
                                    <Heading.H1 location="checkout" className="py-2">Your Accommodation/s</Heading.H1>
                                        ...
                                        <div className="row">
                                            {cartItems.map(item=>{
                                                return(
                                                    <Fragment key={item._id}>                        
                                                        <div className="col-7">                        
                                                            <Heading.H4 location="checkout">{item.name} - {item.quantity} room(s)</Heading.H4>
                                                            <small>{item.nights} night(s)</small>
                                                        </div>
                                                        <div className="col-5">
                                                            <p>{item.price*item.quantity*item.nights}</p>
                                                        </div>
                                                    </Fragment>
                                                )
                                            })}
                                            ...
                                            <Link to="/booking"><Button location="booking">Add more room(s)</Button></Link>
                                </div>
                                <div className="col-12 col-lg-6">
                                    <Heading.H1 location="checkout" className="py-2">Payment Method</Heading.H1>                        
                                        <Stripe 
                                            total={total*100} 
                                            cartItems={cartItems} 
